...
export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "ចូលគណនី ឬចុះឈ្មោះ Dyna Store ដើម្បីទិញហ្គេម និងរក្សាទុកបណ្ណាល័យរបស់អ្នក។",
      },
      { property: "og:title", content: "ចូលប្រើ — Dyna Store" },
      {
        property: "og:description",
        content:
          "ចូលប្រើដោយ Email ឬ Google ដើម្បីបន្ថែម Balance, ទិញហ្គេម, និងគ្រប់គ្រងបណ្ណាល័យរបស់អ្នកនៅ Dyna Store។",
      },
    ...
    <main className="min-h-screen grid place-items-center bg-background px-4">
      <div className="w-full max-w-md rounded-3xl glass p-8 shadow-[var(--shadow-card)]">
        ...
        <h1 className="font-display text-2xl text-center">
          {mode === "login" ? "ចូលប្រើគណនី" : "បង្កើតគណនី"}
        </h1>
        <p className="text-center text-sm text-muted-foreground mt-1">
          ស្វែងរក និងតាមដានហ្គេមដែលអ្នកចូលចិត្ត
        </p>
        ...
        <form onSubmit={submit} className="space-y-3 mt-6">
          <input
            ...
            placeholder="អ៊ីមែល"
            className="w-full rounded-xl bg-input px-4 py-3 text-sm outline-none ring-1 ring-border focus:ring-primary"
          />
          <input
            type="password"
            required
          ...
          <button
            disabled={busy}
            className="w-full rounded-full px-5 py-3 font-semibold text-primary-foreground disabled:opacity-50"
        ...
        >
          <svg className="h-4 w-4" viewBox="0 0 48 48" aria-hidden>
            <path
              fill="#FFC107"
              d="M43.6 20.5H42V20H24v8h11.3C33.7 32.6 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3.1 0 5.9 1.2 8 3.1l5.7-5.7C34.1 6.1 29.3 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.3-.4-3.5z"
            />
            <path
              fill="#FF3D00"
            ...
            <path
              fill="#4CAF50"
              d="M24 44c5.2 0 9.9-2 13.4-5.2l-6.2-5.2C29.3 35 26.8 36 24 36c-5.3 0-9.7-3.4-11.3-8L6.2 33C9.6 39.7 16.3 44 24 44z"
            />
            <path
              fill="#1976D2"
              d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.2 5.6l6.2 5.2C40.9 35.6 44 30.2 44 24c0-1.2-.1-2.3-.4-3.5z"
            />
          </svg>
          បន្តជាមួយ Google
        </button>
