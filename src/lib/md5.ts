// Tiny pure-JS MD5 (public domain, Joseph Myers). Used client-side for KHQR
// payload verification — matches Node's crypto.createHash("md5") output.
...
function md5blk(s: Uint8Array, off: number) {
...
function md51(bytes: Uint8Array) {
