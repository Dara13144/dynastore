...
// Each path's last segment is unique so deriveIdFromUrl yields a unique
// id per row (required for parseBulkLinks to accept them all in one batch).
// Avoid BAD_EXTS like .bin / .exe in the path.
const SAMPLE_PATHS: Record<(typeof SHARE_HOSTS)[number], string> = {
  "uploadnow.io": "/files/uploadnow-FvFBmV6",
  "mediafire.com": "/file/mf-abc123/mediafire-game.zip/file",
  "mega.nz": "/file/meganz-AbCdEf#k",
  "mega.io": "/file/megaio-AbCdEf",
  "drive.google.com": "/file/d/gdrive-1A2B3C/view",
  "pixeldrain.com": "/u/pixeldrain-xyz789",
  "pixeldra.in": "/u/pixeldra-xyz789",
  "gofile.io": "/d/gofileio-Ab12Cd",
  "gofile.to": "/d/gofileto-Ab12Cd",
  "bunkr.ru": "/a/bunkrru-abcd",
  "bunkr.is": "/a/bunkris-abcd",
  ...
  "drop.download": "/dropdownload-abcdef",
  "qiwi.gg": "/file/qiwi-abc123",
  "buzzheavier.com": "/buzzheavier-abc123",
  "files.catbox.moe": "/catbox-abc123.zip",
  "fileditchfiles.me": "/fileditchfiles-game.zip",
  "fileditch.com": "/file/fileditch-abc",
